...
# OUTRO JEITO
def resumo2(a, b=100, c=100):
    print('-' * 40)
    print(f'{"RESUMO DO VALOR":^36}')
    print('-' * 40)
    return f'{"O preço informado foi:":<30} {moeda(a)}\n' + \
           f'{"O dobro do preço é:":<30} {dobro(a)}\n' + \
           f'{"A metade do preço é:":<30} {metade(a)}\n' + \
           f'{b}{"% de aumento:":<28} {aumento(a, b)}\n' + \
           f'{c}{"% de desconto:":<28} {desconto(a, c)}\n' + \
           '-' * 40
